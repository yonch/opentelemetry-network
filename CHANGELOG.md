...
## [0.13.0](https://github.com/yonch/opentelemetry-network/compare/v0.12.0...v0.13.0) (2025-11-18)
...
* **k8s-collector:** add descriptive errors on k8s API connection failure ([43351cc](https://github.com/yonch/opentelemetry-network/commit/43351cc57609006f89e895c51ed5d84ba64b2e60))
* **k8s-collector:** add heartbeat on connection to keep it alive ([1343e9b](https://github.com/yonch/opentelemetry-network/commit/1343e9bc2ccee977be13d3d9d3d6fdf023347b8d))
* **k8s-collector:** add info messages on start ([7feacd0](https://github.com/yonch/opentelemetry-network/commit/7feacd02edd164455f769dee6859f443343af99f))
* **k8s-collector:** add sending of version info message on handshake ([06b0b14](https://github.com/yonch/opentelemetry-network/commit/06b0b1459cec1fb6f92623629ba6d490e53e31b8))
* **k8s-collector:** flush data to reducer at most 100ms after processing ([b0065cc](https://github.com/yonch/opentelemetry-network/commit/b0065ccabf3b92aa2131601cbbcca4f94f572cb3))
* **k8s-collector:** improve reconnection log messaging ([41991c3](https://github.com/yonch/opentelemetry-network/commit/41991c3e82b42959d97640c09dae745f459a01ad))
...
* **deb/rpm:** fix package build for release ([051eddc](https://github.com/yonch/opentelemetry-network/commit/051eddc265440877f18c1d653f245d5ed17a954d))
...
* **k8s-collector:** add connect message to handshake ([388d3f6](https://github.com/yonch/opentelemetry-network/commit/388d3f6ffe6ad98598528a5fa9cdbc4364438dfe))
* **k8s-collector:** keep separate Stores for ReplicaSet and Job metadata ([622ee2f](https://github.com/yonch/opentelemetry-network/commit/622ee2fd36deda2ee2a61b5f3d3d4bbc2ad24bb5))
...
* add release-please for triggering releases ([fe54ff4](https://github.com/yonch/opentelemetry-network/commit/fe54ff4a4d9961054262ac7819f6ec09a0079ada))
...
* update e2e test to include k8s-collector ([94175b1](https://github.com/yonch/opentelemetry-network/commit/94175b12e4683977c4bd9a44ee9b507e060c9d02))
...
* upload e2e container logs as artifacts ([98b91bc](https://github.com/yonch/opentelemetry-network/commit/98b91bcdf68913e70be5072dfcbbe362c1f58243))
...
* verify packaging deb and rpm succeeds ([a2f1e3f](https://github.com/yonch/opentelemetry-network/commit/a2f1e3f37f47c7ab6d127bfb58f2a721fe1ba478))
