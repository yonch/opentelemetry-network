...
impl task_info {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_comm > body.len() { return Err(DecodeError::BufferTooSmall); }
    let comm = if __l_comm == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_comm]).into_owned() };
    __off += __l_comm;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let cgroup_name = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl socket_info {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let remote_dns_name = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl container_info {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_pod > body.len() { return Err(DecodeError::BufferTooSmall); }
    let pod = if __l_pod == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_pod]).into_owned() };
    __off += __l_pod;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[16usize .. 16usize + 2]);
...
impl aws_enrichment {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let id = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl set_pod_detail {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let owner_uid = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl set_container_pod {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let image = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
