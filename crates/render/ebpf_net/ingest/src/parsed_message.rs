...
impl pid_info_create {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let cmdline = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl set_command {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let command = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl container_metadata {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_image > body.len() { return Err(DecodeError::BufferTooSmall); }
    let image = if __l_image == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_image]).into_owned() };
    __off += __l_image;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[18usize .. 18usize + 2]);
    let __l_ip_addr = u16::from_ne_bytes(__b) as usize;
    if __off + __l_ip_addr > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ip_addr = if __l_ip_addr == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_ip_addr]).into_owned() };
    __off += __l_ip_addr;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[20usize .. 20usize + 2]);
    let __l_cluster = u16::from_ne_bytes(__b) as usize;
    if __off + __l_cluster > body.len() { return Err(DecodeError::BufferTooSmall); }
    let cluster = if __l_cluster == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_cluster]).into_owned() };
    __off += __l_cluster;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[22usize .. 22usize + 2]);
    let __l_container_name = u16::from_ne_bytes(__b) as usize;
    if __off + __l_container_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let container_name = if __l_container_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_container_name]).into_owned() };
    __off += __l_container_name;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[24usize .. 24usize + 2]);
    let __l_task_family = u16::from_ne_bytes(__b) as usize;
    if __off + __l_task_family > body.len() { return Err(DecodeError::BufferTooSmall); }
    let task_family = if __l_task_family == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_task_family]).into_owned() };
    __off += __l_task_family;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[26usize .. 26usize + 2]);
    let __l_task_version = u16::from_ne_bytes(__b) as usize;
    if __off + __l_task_version > body.len() { return Err(DecodeError::BufferTooSmall); }
    let task_version = if __l_task_version == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_task_version]).into_owned() };
    __off += __l_task_version;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ns = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl pod_name {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l__deprecated_pod_uid > body.len() { return Err(DecodeError::BufferTooSmall); }
    let _deprecated_pod_uid = if __l__deprecated_pod_uid == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l__deprecated_pod_uid]).into_owned() };
    __off += __l__deprecated_pod_uid;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let name = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl nomad_metadata {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_group_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let group_name = if __l_group_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_group_name]).into_owned() };
    __off += __l_group_name;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[16usize .. 16usize + 2]);
    let __l_task_name = u16::from_ne_bytes(__b) as usize;
    if __off + __l_task_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let task_name = if __l_task_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_task_name]).into_owned() };
    __off += __l_task_name;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let job_name = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl k8s_metadata {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_pod_ns > body.len() { return Err(DecodeError::BufferTooSmall); }
    let pod_ns = if __l_pod_ns == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_pod_ns]).into_owned() };
    __off += __l_pod_ns;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[18usize .. 18usize + 2]);
    let __l_pod_uid = u16::from_ne_bytes(__b) as usize;
    if __off + __l_pod_uid > body.len() { return Err(DecodeError::BufferTooSmall); }
    let pod_uid = if __l_pod_uid == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_pod_uid]).into_owned() };
    __off += __l_pod_uid;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let sandbox_uid = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl container_resource_limits_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 41usize { return Err(DecodeError::BufferTooSmall); }
...
impl container_resource_limits {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 45usize { return Err(DecodeError::BufferTooSmall); }
...
impl container_annotation {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_key > body.len() { return Err(DecodeError::BufferTooSmall); }
    let key = if __l_key == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_key]).into_owned() };
    __off += __l_key;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let value = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl nat_remapping {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 22usize { return Err(DecodeError::BufferTooSmall); }
...
impl set_node_info {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_instance_id > body.len() { return Err(DecodeError::BufferTooSmall); }
    let instance_id = if __l_instance_id == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_instance_id]).into_owned() };
    __off += __l_instance_id;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let instance_type = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl set_availability_zone_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 19usize { return Err(DecodeError::BufferTooSmall); }
...
impl set_iam_role_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 67usize { return Err(DecodeError::BufferTooSmall); }
...
impl dns_response_fake {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_ips > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ips = if __l_ips == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_ips]).into_owned() };
    __off += __l_ips;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let domain_name = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl dns_response_dep_a_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_domain_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let domain_name = if __l_domain_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_domain_name]).into_owned() };
    __off += __l_domain_name;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[8usize .. 8usize + 2]);
    let __l_ipv4_addrs = u16::from_ne_bytes(__b) as usize;
    if __off + __l_ipv4_addrs > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ipv4_addrs = if __l_ipv4_addrs == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_ipv4_addrs]).into_owned() };
    __off += __l_ipv4_addrs;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ipv6_addrs = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl set_config_label_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 62usize { return Err(DecodeError::BufferTooSmall); }
...
impl api_key {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 86usize { return Err(DecodeError::BufferTooSmall); }
...
impl pod_new_legacy {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_uid > body.len() { return Err(DecodeError::BufferTooSmall); }
    let uid = if __l_uid == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_uid]).into_owned() };
    __off += __l_uid;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[10usize .. 10usize + 2]);
    let __l_owner_name = u16::from_ne_bytes(__b) as usize;
    if __off + __l_owner_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let owner_name = if __l_owner_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_owner_name]).into_owned() };
    __off += __l_owner_name;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[12usize .. 12usize + 2]);
    let __l_owner_uid = u16::from_ne_bytes(__b) as usize;
    if __off + __l_owner_uid > body.len() { return Err(DecodeError::BufferTooSmall); }
    let owner_uid = if __l_owner_uid == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_owner_uid]).into_owned() };
    __off += __l_owner_uid;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ns = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl pod_container_legacy {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let container_id = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl pod_container {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_container_id > body.len() { return Err(DecodeError::BufferTooSmall); }
    let container_id = if __l_container_id == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_container_id]).into_owned() };
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let container_image = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl connect {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let hostname = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl health_check {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let origin = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl agent_resource_usage {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 54usize { return Err(DecodeError::BufferTooSmall); }

    // Decode fixed header fields
    let user_mode_time_us = u64::from_ne_bytes(body[8usize .. 8usize + 8].try_into().unwrap());
    let kernel_mode_time_us = u64::from_ne_bytes(body[16usize .. 16usize + 8].try_into().unwrap());
    let max_resident_set_size = u64::from_ne_bytes(body[24usize .. 24usize + 8].try_into().unwrap());
    ...
    let voluntary_context_switch_count = u32::from_ne_bytes(body[44usize .. 44usize + 4].try_into().unwrap());
    let involuntary_context_switch_count = u32::from_ne_bytes(body[48usize .. 48usize + 4].try_into().unwrap());
...
impl cloud_platform {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 4usize { return Err(DecodeError::BufferTooSmall); }
...
impl os_info_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let kernel_version = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl kernel_headers_source {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 3usize { return Err(DecodeError::BufferTooSmall); }
...
impl cloud_platform_account_info {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let account_id = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl collector_health {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 6usize { return Err(DecodeError::BufferTooSmall); }
...
impl system_wide_process_settings {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    // Decode fixed header fields
    let clock_ticks_per_second = u64::from_ne_bytes(body[8usize .. 8usize + 8].try_into().unwrap());
...
impl collect_blob {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_metadata > body.len() { return Err(DecodeError::BufferTooSmall); }
    let metadata = if __l_metadata == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_metadata]).into_owned() };
    __off += __l_metadata;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let blob = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl report_cpu_cores {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 8usize { return Err(DecodeError::BufferTooSmall); }
...
impl network_interface_info_deprecated {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_interface_id > body.len() { return Err(DecodeError::BufferTooSmall); }
    let interface_id = if __l_interface_id == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_interface_id]).into_owned() };
    ...
    if __off + __l_instance_owner_id > body.len() { return Err(DecodeError::BufferTooSmall); }
    let instance_owner_id = if __l_instance_owner_id == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_instance_owner_id]).into_owned() };
    __off += __l_instance_owner_id;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[20usize .. 20usize + 2]);
    let __l_public_dns_name = u16::from_ne_bytes(__b) as usize;
    if __off + __l_public_dns_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let public_dns_name = if __l_public_dns_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_public_dns_name]).into_owned() };
    __off += __l_public_dns_name;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[22usize .. 22usize + 2]);
    let __l_private_dns_name = u16::from_ne_bytes(__b) as usize;
    if __off + __l_private_dns_name > body.len() { return Err(DecodeError::BufferTooSmall); }
    let private_dns_name = if __l_private_dns_name == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_private_dns_name]).into_owned() };
    __off += __l_private_dns_name;
    let __tail = (__len as usize).saturating_sub(__off);
    if __off + __tail > body.len() { return Err(DecodeError::BufferTooSmall); }
    let interface_description = if __tail == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __tail]).into_owned() };
...
impl network_interface_info {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if __off + __l_ip_owner_id > body.len() { return Err(DecodeError::BufferTooSmall); }
    let ip_owner_id = if __l_ip_owner_id == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_ip_owner_id]).into_owned() };
    __off += __l_ip_owner_id;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[6usize .. 6usize + 2]);
    let __l_vpc_id = u16::from_ne_bytes(__b) as usize;
    if __off + __l_vpc_id > body.len() { return Err(DecodeError::BufferTooSmall); }
    let vpc_id = if __l_vpc_id == 0 { ::std::string::String::new() } else { ::std::string::String::from_utf8_lossy(&body[__off .. __off + __l_vpc_id]).into_owned() };
    __off += __l_vpc_id;
    // length from header
    let mut __b = [0u8;2];
    __b.copy_from_slice(&body[16usize .. 16usize + 2]);
...
impl udp_stats_addr_changed_v4 {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 21usize { return Err(DecodeError::BufferTooSmall); }
...
impl udp_stats_addr_changed_v6 {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 33usize { return Err(DecodeError::BufferTooSmall); }
...
impl udp_stats_drops_changed {
  ...
  pub fn decode(body: &[u8]) -> Result<Self, DecodeError> {
    ...
    if body.len() < 12usize { return Err(DecodeError::BufferTooSmall); }
